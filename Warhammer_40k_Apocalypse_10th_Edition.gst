...
<gameSystem id="440c-9567-ca71-f95b" name="Warhammer 40,000 Apocalypse 10th Edition" revision="15" battleScribeVersion="2.03" authorName="Th3Proj3ct" authorContact="" authorUrl="https://github.com/th3proj3ct/wh40k-fundapocalypse/" xmlns="http://www.battlescribe.net/schema/gameSystemSchema">
  <publications>
  ...
  <categoryEntries>
    ...
    <categoryEntry id="351c-b6fa-4d4f-70f3" name="Mounted" hidden="false"/>
        ...
        <selectionEntry id="ff1b-fab5-8c75-89dc" name="01 - Master Strategist" publicationId="8df9-0b3e-abea-3c15" hidden="false" collective="false" import="true" type="upgrade">
          ...
          <profiles>
            <profile id="2838-7f5e-7bac-5104" name="01 - Master Strategist" publicationId="8df9-0b3e-abea-3c15" hidden="false" typeId="96ed-cabc-a90c-b284" typeName="Warmaster Trait">
              <characteristics>
                <characteristic name="Description" typeId="4ad5-e76c-6781-da08">Gain an extra command point each turn while this Warmaster is alive.</characteristic>
              </characteristics>
            </profile>
          </profiles>
          <costs>
        ...
        <selectionEntry id="7a24-0103-6606-2d37" name="11 - Born Survivor" publicationId="8df9-0b3e-abea-3c15" hidden="false" collective="false" import="true" type="upgrade">
          ...
          <profiles>
            <profile id="52d9-58d8-1438-d962" name="11 - Born Survivor" publicationId="8df9-0b3e-abea-3c15" hidden="false" typeId="96ed-cabc-a90c-b284" typeName="Warmaster Trait">
              <characteristics>
                <characteristic name="Description" typeId="4ad5-e76c-6781-da08">This unit gains the [IGNORE DAMAGE 6+] ability.</characteristic>
              </characteristics>
            </profile>
          </profiles>
          <infoLinks>
        ...
        <selectionEntry id="768d-3f65-8ef4-c4bb" name="09 - Martial Discipline" publicationId="8df9-0b3e-abea-3c15" hidden="false" collective="false" import="true" type="upgrade">
          ...
          <profiles>
            <profile id="0a04-d1d8-1d96-1278" name="09 - Martial Discipline" publicationId="8df9-0b3e-abea-3c15" hidden="false" typeId="96ed-cabc-a90c-b284" typeName="Warmaster Trait">
              <characteristics>
                <characteristic name="Description" typeId="4ad5-e76c-6781-da08">Friendly units that are within 12&quot; of this unit when they Fall Back can stiull make Shoot and/or Fight actions this phase.</characteristic>
              </characteristics>
            </profile>
          </profiles>
          <costs>
        ...
        <selectionEntry id="3821-a34b-cca3-4370" name="05 - Supreme Tactician" publicationId="8df9-0b3e-abea-3c15" hidden="false" collective="false" import="true" type="upgrade">
          ...
          <profiles>
            <profile id="0fc7-76fe-d60e-988d" name="05 - Supreme Tactician" publicationId="8df9-0b3e-abea-3c15" hidden="false" typeId="96ed-cabc-a90c-b284" typeName="Warmaster Trait">
              <characteristics>
                <characteristic name="Description" typeId="4ad5-e76c-6781-da08">Once per turn, you can change the order of a friendly Detachment before that Detachment is activated in the Action phase</characteristic>
              </characteristics>
            </profile>
          </profiles>
          <costs>
        ...
        <selectionEntry id="1c02-f4fc-4236-83fe" name="03 - Stealth Adept" publicationId="8df9-0b3e-abea-3c15" hidden="false" collective="false" import="true" type="upgrade">
          ...
          <profiles>
            <profile id="abd3-108e-be30-808a" name="03 - Stealth Adept" publicationId="8df9-0b3e-abea-3c15" hidden="false" typeId="96ed-cabc-a90c-b284" typeName="Warmaster Trait">
              <characteristics>
                <characteristic name="Description" typeId="4ad5-e76c-6781-da08">This unit gains the Stealth keyword</characteristic>
              </characteristics>
            </profile>
          </profiles>
          <infoLinks>
...
If this unit is garrisoning Defensible Terrain, unmodified saving throws of 5+ are automatically successful, irrespective of this unit&apos;s Save characteristic.</description>
    ...
    <rule id="38fe-82df-e27f-cb00" name="Sticky Objective" hidden="false">
    ...
    <rule id="3d87-2088-2f3b-4474" name="Hazardous" hidden="false">
      <description>After a unit shoots or fights, roll one Hazardous test (one D6) for each Hazardous weapon used. For each 1,  place one blast marker next to the firing unit.</description>
    </rule>
    <rule id="20f9-1ef3-c635-7deb" name="Lethal Hits" hidden="false">
    ...
    <rule id="ddb8-a308-92c6-c90a" name="Lance" hidden="false">
    ...
    <rule id="90b6-9d4b-d503-5e51" name="Twin-Linked" hidden="false">
  ...
  <sharedProfiles>
    ...
    <profile id="d252-8f28-994e-d9b2" name="Scouts X" hidden="false" typeId="f075-616f-79da-32a6" typeName="Abilities">
      <characteristics>
        <characteristic name="Description" typeId="4493-9fa3-8c30-866f">Scouts x&quot;: Unit can make a Normal move of up to x&quot; before the first turn begins.</characteristic>
      </characteristics>
    </profile>
